export default function Quote() {
  return (
    <section className="w-full bg-white">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-center px-6 py-16 text-center md:max-w-2xl md:py-10">
        <h3 className="mb-2 text-xl leading-relaxed font-medium sm:text-2xl md:text-4xl">
          ...
          <br className="hidden sm:block" /> dla biznesem każdej
          firmy.”
        </h3>
